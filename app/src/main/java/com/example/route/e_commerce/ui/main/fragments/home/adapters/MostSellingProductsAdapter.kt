...
import com.example.route.e_commerce.utils.MyDiffUtil


class MostSellingProductsAdapter(private val context: Context) :
    RecyclerView.Adapter<MostSellingProductsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): MostSellingProductsAdapter.ViewHolder {
        return ViewHolder(
            context,
    ...
    override fun onBindViewHolder(
        holder: MostSellingProductsAdapter.ViewHolder,
        position: Int,
    ) {
